    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_gaugeRudderPort = new wxGauge(
        this, wxID_ANY, 30, wxDefaultPosition, wxSize(-1, -1), wxGA_HORIZONTAL);
    ...
    bSizer92->Add(
        m_gaugeRudderPort, 1, wxALIGN_RIGHT | wxBOTTOM | wxEXPAND | wxTOP, 5);

    m_gaugeRudderStbd = new wxGauge(
        this, wxID_ANY, 30, wxDefaultPosition, wxSize(-1, -1), wxGA_HORIZONTAL);
    ...
    m_SliderRudder = new wxSlider(this, wxID_ANY, 30, 0, 60, wxDefaultPosition,
        wxSize(300, -1), wxSL_AUTOTICKS | wxSL_BOTH | wxSL_HORIZONTAL);
    ...
    m_textCtrlRudderPort = new wxTextCtrl(this, wxID_ANY, wxEmptyString,
        wxDefaultPosition, wxDefaultSize, wxTE_READONLY | wxTE_CENTER);
    m_textCtrlRudderPort->SetFont(wxFont(10, wxFONTFAMILY_SWISS,
        wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxT("Arial")));

    bSizer131->Add(
        m_textCtrlRudderPort, 0, wxALIGN_CENTER_VERTICAL | wxALIGN_RIGHT, 0);

    m_buttonMid = new wxButton(
    ...
    m_textCtrlRudderStbd = new wxTextCtrl(this, wxID_ANY, wxEmptyString,
        wxDefaultPosition, wxDefaultSize, wxTE_READONLY | wxTE_CENTER);
    m_textCtrlRudderStbd->SetFont(wxFont(10, wxFONTFAMILY_SWISS,
        wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxT("Arial")));

    bSizer131->Add(
        m_textCtrlRudderStbd, 0, wxALIGN_BOTTOM | wxALIGN_CENTER_VERTICAL, 0);
    ...
    m_bpPlay = new wxButton(
        this, wxID_ANY, _("Start"), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    m_bpStop = new wxButton(
        this, wxID_ANY, _("Stop"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticTextHeading = new wxStaticText(
        this, wxID_ANY, _("  Heading:  "), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_stHeading = new wxStaticText(
        this, wxID_ANY, _("000"), wxDefaultPosition, wxDefaultSize, 0);
    m_stHeading->Wrap(-1);
    ...
    m_staticTextKnots = new wxStaticText(this, wxID_ANY,
        _("             Speed: "), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextKnots->Wrap(-1);
    m_staticTextKnots->SetFont(wxFont(12, wxFONTFAMILY_SWISS,
        wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxT("Arial")));

    bSizer7->Add(m_staticTextKnots, 0, wxALIGN_CENTER_VERTICAL, 5);

    m_stSpeed = new wxStaticText(
        this, wxID_ANY, _("0"), wxDefaultPosition, wxDefaultSize, 0);
    m_stSpeed->Wrap(-1);
    ...
    m_staticText81 = new wxStaticText(
        this, wxID_ANY, _("        Kts"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    bSizer6->Add(
        bSizer7, 1, wxEXPAND | wxALIGN_BOTTOM | wxALIGN_CENTER_HORIZONTAL, 5);
    ...
    m_SliderSpeed = new wxSlider(
        this, wxID_ANY, 0, 0, 100, wxDefaultPosition, wxSize(300, -1), 0);
    ...
    m_staticText8 = new wxStaticText(
        this, wxID_ANY, _("100"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_buttonStandby = new wxButton(
        this, wxID_ANY, _("Stby"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_buttonAuto = new wxButton(
        this, wxID_ANY, _("Auto"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_button7 = new wxButton(
        this, wxID_ANY, _("Follow"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_buttonWind = new wxButton(
        this, wxID_ANY, _("Sail"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_buttonMinus1 = new wxButton(
        this, wxID_ANY, _("-1"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_buttonMinus10 = new wxButton(
        this, wxID_ANY, _("-10"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    // Connect Events
    this->Connect(
        wxEVT_CLOSE_WINDOW, wxCloseEventHandler(ShipDriverBase::OnClose));
    m_buttonMid->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(ShipDriverBase::OnMidships), NULL, this);
    ...
    m_buttonStandby->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(ShipDriverBase::OnStandby), NULL, this);
    m_buttonAuto->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(ShipDriverBase::OnAuto), NULL, this);
    m_button7->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(ShipDriverBase::OnFollow), NULL, this);
    m_buttonWind->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(ShipDriverBase::OnWind), NULL, this);
    m_buttonMinus1->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(ShipDriverBase::OnMinus1), NULL, this);
    m_buttonMinus10->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(ShipDriverBase::OnMinus10), NULL, this);
    m_buttonPlus10->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(ShipDriverBase::OnPlus10), NULL, this);
    m_buttonPlus1->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(ShipDriverBase::OnPlus1), NULL, this);
    this->Connect(
        wxID_ANY, wxEVT_TIMER, wxTimerEventHandler(ShipDriverBase::OnTimer));
}
    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    sbSizer1 = new wxStaticBoxSizer(
        new wxStaticBox(this, wxID_ANY, _("AIS")), wxVERTICAL);
    ...
    m_cbTransmitAis = new wxCheckBox(sbSizer1->GetStaticBox(), wxID_ANY,
        _("Transmit"), wxDefaultPosition, wxDefaultSize, 0);
    fgSizer2->Add(m_cbTransmitAis, 0, wxALL, 5);

    m_cbAisToFile = new wxCheckBox(sbSizer1->GetStaticBox(), wxID_ANY,
        _("Save to file"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_textCtrlMMSI = new wxTextCtrl(sbSizer2->GetStaticBox(), wxID_ANY,
